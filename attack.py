...
def regist(name,phone):
	boundary='-------------------------7df3069603d6'  
	data=[]  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="frm_action"\r\n')  
	data.append('create')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="form_id"\r\n')  
	data.append('3')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="frm_hide_fields_3"\r\n')  
	data.append('')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="form_key"\r\n')  
	data.append('uelho')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="item_meta[0]"\r\n')  
	data.append('')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="frm_submit_entry_3"\r\n')  
	data.append('3d476b0a58')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="_wp_http_referer"\r\n')  
	data.append('/')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="frm_verify"\r\n')  
	data.append('')  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="item_meta[10]"\r\n')   
	data.append(name)  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="item_meta[11]"\r\n')   
	data.append(phone)  
	data.append('--%s' % boundary)  
	data.append('Content-Disposition: form-data; name="item_key"\r\n')  
	data.append('')  
	data.append('--%s' % boundary)  
	...
	print httpBody  
	'''
	postDataUrl='http://www.39dbt.com/'  
...
def loop0():
    ...
    print(regist(full_name(last_names, first_names),createPhone()))
